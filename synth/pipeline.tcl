...
#/*   Usage       : dc_shell-t -f pipeline.tcl              */
...
# the environment variable is set by the Makefile and can speed up synthesis compilation times
...
# NOTE: this is separated into a different file for custom tuning of commands below
# otherwise, it is the same as module.tcl
